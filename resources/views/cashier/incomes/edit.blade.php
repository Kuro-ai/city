<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form class="max-w-sm mx-auto bg-bgcyan border-2 border-pale p-6 rounded-md" id="incomeForm" method="POST" action="{{ route('cashier.incomes.update', $income->id) }}">
                @csrf
                @method('PUT')
                <div class="flex justify-end">
                    <x-create-button href="{{ route('cashier.incomes.index') }}">
                        Income List
                    </x-create-button>
                </div>
                <div id="incomeItems">
