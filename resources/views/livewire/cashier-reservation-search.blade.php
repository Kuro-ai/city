                        ...
                        <tr class="bg-bgcyan text-pale border-2 border-pale">
                            ...
                            <td scope="row" class="px-6 py-4 font-medium whitespace-nowrap">
                                <div class="flex space-x-2 justify-center items-center">
                                    <a href="{{ route('cashier.reservations.edit', $reservation->id) }}"
                                    ...
                                    <form class="px-2 py-3 hover:bg-red-400 rounded-lg text-white"
                                        action="{{ route('cashier.reservations.destroy', $reservation->id) }}"
                                    ...
                                    @if (!$reservation->email_sent)
                                        <form class="px-2 py-3 hover:bg-blue-400 rounded-lg text-white"
                                            action="{{ route('cashier.reservations.reservationemail', $reservation->id) }}"
                                            method="POST"
