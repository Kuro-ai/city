<div>
    <div class="flex justify-between">
        ...
        <x-create-button href="{{ route('manager.reservations.create') }}">
            New Reservation
        </x-create-button>
    </div>
                        ...
                        <tr class="bg-bgcyan text-pale border-2 border-pale">
                            ...
                            <td scope="row" class="px-6 py-4 font-medium whitespace-nowrap">
                                <div class="flex space-x-2 justify-center items-center">
                                    <a href="{{ route('manager.reservations.edit', $reservation->id) }}"
                                    ...
                                    <form class="px-2 py-3 hover:bg-red-400 rounded-lg text-white"
                                        action="{{ route('manager.reservations.destroy', $reservation->id) }}"
                                    ...
                                    @if (!$reservation->email_sent && !$reservation->user->hasRole(['admin', 'manager', 'staff']))
                                        <form class="px-2 py-3 hover:bg-blue-400 rounded-lg text-white"
                                            action="{{ route('manager.reservations.reservationemail', $reservation->id) }}"
                                            method="POST"
