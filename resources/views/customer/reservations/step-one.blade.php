                            ...
                            <form method="POST" action="{{ route('customer.reservations.store.step.one') }}">
                                ...
                                <div class="mb-5 sm:col-span-6">
                                    ...
                                    <input type="text" id="first_name"
                                        class="shadow-sm bg-bgcyan border border-pale text-pale text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 @error('first_name') border-red-600 @enderror"
                                ...
                                <div class="mb-5 sm:col-span-6">
                                    ...
                                    <input type="text" id="last_name"
                                        class="shadow-sm bg-bgcyan border border-pale text-pale text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 @error('last_name') border-red-600 @enderror"
                                ...
                                <div class="mb-5 sm:col-span-6">
                                    ...
                                    <input type="email" id="email"
                                        class="shadow-sm bg-bgcyan border border-pale text-pale text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 @error('email') border-red-600 @enderror"
                                ...
                                <div class="mb-5 sm:col-span-6">
                                    ...
                                    <input type="text" id="tel_number"
                                        class="shadow-sm bg-bgcyan border border-pale text-pale text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 @error('tel_number') border-red-600 @enderror"
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-bbyellow hover:bg-yellow-300 rounded-lg text-bgcyan">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
