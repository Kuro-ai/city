            ...
            <form class="max-w-sm mx-auto bg-slate-300 p-6 rounded-md"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="first_name"
                        ...
                        placeholder="First Name" name="first_name" value="{{$reservation->first_name}}" required />
                </div>
                <div class="mb-5">
                    ...
                    <input type="text" id="last_name"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Last Name" name="last_name" value="{{$reservation->last_name}}" required />
                </div>
                <div class="mb-5">
                    <label for="email"
                    ...
                    <input type="email" id="email"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="example@gmail.com" name="email" value="{{$reservation->email}}"  required />
                </div>
                <div class="mb-5">
                    ...
                    <input type="text" id="tel_number"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="09-xxx xxxxxx" name="tel_number" value="{{$reservation->tel_number}}" required onkeypress="return isNumberKey(event)" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="datetime-local" id="res_date"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Last Name" name="res_date" value="{{$reservation->res_date}}"  required />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" id="guest_number"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="guest_number" name="guest_number" value="{{$reservation->guest_number}}" min="1" max="12" step="1"
                        required />
                </div>
