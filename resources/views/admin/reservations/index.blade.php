            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm rtl:text-right text-gray-500 text-center">
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach ($reservations as $category)
                                <tr class="odd:bg-white even:bg-gray-50">
                                    ...
                                    <td scope="row"
                                        ...
                                        <img src="{{ asset('reservations') }}/{{ $category->image }}" height="100"
                                            width="100" class="rounded" alt="{{ $category->name }}">
                                    </td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        <div class="flex space-x-2 justify-center items-center">
                                            <a href="{{ route('admin.reservations.edit', $category->id) }}"
                                            ...
                                            <form class="px-2 py-3 bg-red-500 hover:bg-red-700 rounded-lg text-white"
                                                action="{{ route('admin.reservations.destroy', $category->id) }}"
