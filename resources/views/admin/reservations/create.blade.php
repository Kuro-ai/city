            ...
            <form class="max-w-sm mx-auto bg-slate-300 p-6 rounded-md" action="{{ route('admin.reservations.store') }}"
                ...
                <div class="mb-5">
                    ...
                    <input type="datetime-local" id="res_date"
                        class="message shadow-sm bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('res_date') border-red-600 @enderror"
