            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm rtl:text-right text-gray-500 text-center">
                    ...
                    <tbody>
                        @if (empty($menus))
                            <tr>
                                <td colspan="4" class="px-6 py-4 whitespace-nowrap text-center">No menus found
                                </td>
                            </tr>
                        @else
                            @foreach ($menus as $menu)
                                <tr class="odd:bg-white even:bg-gray-50">
                                    ...
                                    <td scope="row"
                                        ...
                                        <img src="{{ asset('menus') }}/{{ $menu->image }}" height="100"
                                            width="100" class="rounded" alt="{{ $menu->name }}">
                                    </td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        {{ $menu->price }}
                                    </td>
