<x-app-layout>
    ...
    <div class="flex items-center justify-center h-screen text-center ">
        <div class="block max-w p-10 bg-white border border-gray-200 rounded-lg shadow">
            ...
            {{-- <a href="{{ route('admin.index') }}" class="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-blue-600 rounded shadow ripple hover:shadow-lg hover:bg-blue-800 focus:outline-none">
                Go back to Home
            </a> --}}

            <form id="orderForm" method="POST" action="{{ route('admin.order.startOrder') }}">
                @csrf
