...
class ManagerMenuController extends Controller
{
    ...
    {
        $menus = MenuModel::all();
        return view('manager.menus.menuslist', compact('menus'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.menus.create')->with('categories', $categories);
    }
    ...
    public function edit(string $id)
    {
        ...
        $categories = CategoryModel::all();
        return view('manager.menus.edit')->with('menu', $menu)->with('categories', $categories);
    }
