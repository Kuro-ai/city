...
class ManagerIncomeController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('manager.incomes.index', compact('incomes', 'totalPrice'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.incomes.create', ['menus' => $menus]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('manager.incomes.create')->withErrors($validator)->withInput();
        } else {
            $income = new Income();
            ...
            return redirect()->route('manager.incomes.show', ['income' => $income->id]);
        }
    }
    ...
    public function download(string $id)
    {
        ...
        $pdf = PDF::loadView('manager.invoice', ['income' => $income]);

        session()->flash('status', 'PDF is successfully generated!');

        // Download the PDF
        return $pdf->download('invoice.pdf')->withHeaders([
            'Refresh' => '3; url=' . route('manager.incomes.show', ['income' => $income->id]),
        ]);
    }
    ...
    {
        $income = Income::findOrFail($id);
        return view('manager.incomes.index', compact('income'));
    }
    ...
    public function edit(string $id)
    {
        $income = Income::findOrFail($id);
        $menus = MenuModel::all();
        return view('manager.incomes.edit', compact('income', 'menus'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('manager.incomes.index');
    }
