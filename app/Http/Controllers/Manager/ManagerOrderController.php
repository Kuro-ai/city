...
class ManagerOrderController extends Controller
{
    ...
    public function showStartOrder()
    {
        ...
        return view('manager.menus.index', ['reservation_id' => $reservationId]);
    }
    ...
    public function showCart()
    {
        ...
        return view('manager.order.shoppingcart', ['cartItems' => $cartItems, 'orderSummary' => $orderSummary, 'reservation_id' => $reservationId]);
    }
    ...
    public function updateCart(Request $request)
    {
        ...
        return redirect()->route('manager.order.shoppingcart');
    }
    ...
    public function cartToCheckout(Request $request)
    {
        ...
        session()->put('cartItems', $cartItems);
        return redirect()->route('manager.order.checkout');
    }
    ...
    public function checkout()
    {
        ...
        return view('manager.order.checkout', ['cartItems' => $cartItems, 'reservation' => $reservation, 'total' => $total, 'orderSummary' => $orderSummary]);
    }
    ...
    public function orderemail($id)
    {
        ...
        return redirect()->route('manager.orders.index')->with('status', 'Email is successfully sent!');
    }
