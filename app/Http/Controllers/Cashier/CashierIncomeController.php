...
class CashierIncomeController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('cashier.incomes.index', compact('incomes', 'totalPrice'));
    }
    ...
    public function create()
    {
        ...
        return view('cashier.incomes.create', ['menus' => $menus]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('cashier.incomes.create')->withErrors($validator)->withInput();
        } else {
            $income = new Income();
            ...
            return redirect()->route('cashier.incomes.show', ['income' => $income->id]);
        }
    }
    ...
    public function download(string $id)
    {
        ...
        $pdf = PDF::loadView('cashier.invoice', ['income' => $income]);

        session()->flash('status', 'PDF is successfully generated!');

        // Download the PDF
        return $pdf->download('invoice.pdf')->withHeaders([
            'Refresh' => '3; url=' . route('cashier.incomes.show', ['income' => $income->id]),
        ]);
    }
    ...
    {
        $income = Income::findOrFail($id);
        return view('cashier.incomes.index', compact('income'));
    }
    ...
    public function edit(string $id)
    {
        $income = Income::findOrFail($id);
        $menus = MenuModel::all();
        return view('cashier.incomes.edit', compact('income', 'menus'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('cashier.incomes.index');
    }
