...
class CashierOrderController extends Controller
{
    ...
    public function showStartOrder()
    {
        ...
        return view('cashier.menus.index', ['reservation_id' => $reservationId]);
    }
    ...
    public function showCart()
    {
        ...
        return view('cashier.order.shoppingcart', ['cartItems' => $cartItems, 'orderSummary' => $orderSummary, 'reservation_id' => $reservationId]);
    }
    ...
    public function updateCart(Request $request)
    {
        ...
        return redirect()->route('cashier.order.shoppingcart');
    }
    ...
    public function cartToCheckout(Request $request)
    {
        ...
        session()->put('cartItems', $cartItems);
        return redirect()->route('cashier.order.checkout');
    }
    ...
    public function checkout()
    {
        ...
        return view('cashier.order.checkout', ['cartItems' => $cartItems, 'reservation' => $reservation, 'total' => $total, 'orderSummary' => $orderSummary]);
    }
    ...
    public function orderemail($id)
    {
        ...
        return redirect()->route('cashier.orders.index')->with('status', 'Email is successfully sent!');
    }
