...
class CashierReservationController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('cashier.reservations.index', ['reservations' => $reservations]);
    }
    ...
    public function create()
    {
        ...
        return view('cashier.reservations.create')->with('tables', $tables);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cashier.thankyou');
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        $tables = TableModel::where('status', TableStatus::Available)->get();
        return view('cashier.reservations.edit')->with('reservation', $reservation)->with('tables', $tables);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('cashier.reservations.index');
    }
    ...
    public function reservationemail($id)
    {
        ...
        return redirect()->route('cashier.reservations.index')->with('status', 'Email is successfully sent!');
    }
}
