...
class StaffOrderController extends Controller
{
    ...
    public function showStartOrder()
    {
        ...
        return view('staff.menus.index', ['reservation_id' => $reservationId]);
    }
    ...
    public function showCart()
    {
        ...
        return view('staff.order.shoppingcart', ['cartItems' => $cartItems, 'orderSummary' => $orderSummary, 'reservation_id' => $reservationId]);
    }
    ...
    public function updateCart(Request $request)
    {
        ...
        return redirect()->route('staff.order.shoppingcart');
    }
    ...
    public function cartToCheckout(Request $request)
    {
        ...
        session()->put('cartItems', $cartItems);
        return redirect()->route('staff.order.checkout');
    }
    ...
    public function checkout()
    {
        ...
        return view('staff.order.checkout', ['cartItems' => $cartItems, 'reservation' => $reservation, 'total' => $total, 'orderSummary' => $orderSummary]);
    }
    ...
    public function orderemail($id)
    {
        ...
        return redirect()->route('staff.orders.index')->with('status', 'Email is successfully sent!');
    }
