...
class StaffReservationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('staff.reservations.create')->with('tables', $tables);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.thankyou');
    }
    /**
    ...
    public function edit(string $id)
    {
        ...
        $tables = TableModel::where('status', TableStatus::Available)->get();
        return view('staff.reservations.edit')->with('reservation', $reservation)->with('tables', $tables);
    }
    ...
    public function reservationemail($id)
    {
        ...
        return redirect()->route('staff.reservations.index')->with('status', 'Email is successfully sent!');
    }
}
